...
sAll<-read.table("Real_Mix_activity.csv", sep="",header=T)
...
a<-ggplot(Ta2,aes(x=cond,y=absdY,group=cond,color=cond))+
  ...
  scale_color_manual(values=c("#54C6CC","#0C9743","#7D7F39"))+
  scale_fill_manual(values=c("#54C6CC","#0C9743","#7D7F39"))+
